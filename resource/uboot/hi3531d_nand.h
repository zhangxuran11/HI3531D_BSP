...
#ifndef __CONFIG_HI3531D_H__
#define __CONFIG_HI3531D_H__
...
/*-----------------------------------------------------------------------
 * for timer configuration (udelay)	cpu/hi3531d/hi3531d/timer.c
 * enable timer				board/hi3531d/board.c
 *----------------------------------------------------------------------*/
...
/*-----------------------------------------------------------------------
 * for bootm linux
 * used in file board/hi3531d/board.c
 -----------------------------------------------------------------------*/
...
/* Except bootrom, hi3531d use XTAL OSC clk 24M */
...
#define CONFIG_PRODUCTNAME	"hi3531d"
